...
# test /fhir_bundle endpoint

real_fhir_bundle_with_patient1 = {
    "resourceType": "Bundle",
    "type": "collection",
    "entry": [
        {
            "fullUrl": "urn:oid:1.2.36.146.595.217.0.1",
            "resource": {
...
real_fhir_bundle_with_patient2 = {
        "resourceType": "Bundle",
        "type": "collection",
        "entry": [
            {
...

      {
        ...
        "resource": {
          ...
          "effectiveDateTime": "2022-02-04T08:00:00Z"
        }
      },
      {
        "fullUrl": "urn:uuid:5db7d90d-6c7b-4e2f-ba22-5e4e47d6862a",
...
real_fhir_bundle_with_patient3 = {
        "resourceType": "Bundle",
        "type": "collection",
        "entry": [
            {
...

      {
        ...
        "resource": {
          ...
          "effectiveDateTime": "2022-03-04T08:00:00Z"
        }
      },
      {
        "fullUrl": "urn:uuid:5db7d90d-6c7b-4e2f-ba22-5e4e47d6862a",
...
response = requests.post(url, json=real_fhir_bundle_with_patient3)
